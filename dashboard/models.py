...
class CustomerCustomerDemo(models.Model):
    customer = models.OneToOneField(
        "Customers", models.DO_NOTHING, primary_key=True
    )  # The composite primary key (customer_id, customer_type_id) found, that is not supported. The first column is selected.
...
class EmployeeTerritories(models.Model):
    employee = models.OneToOneField(
        "Employees", models.DO_NOTHING, primary_key=True
    )  # The composite primary key (employee_id, territory_id) found, that is not supported. The first column is selected.
...
class OrderDetails(models.Model):
    order = models.OneToOneField(
        "Orders", models.DO_NOTHING, primary_key=True
